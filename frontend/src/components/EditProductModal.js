import {
  ...
  function EditProductModal({ Originalproduct }) {
    ...
    const [product, setProduct] = useState({
      ...
      global: Originalproduct.global,
      senderFee: Originalproduct.senderFee,
      senderFeePercentage: Originalproduct.senderFeePercentage,
      discountPercentage: Originalproduct.discountPercentage,
      denominationType: Originalproduct.denominationType,
      recipientCurrencyCode:  Originalproduct.recipientCurrencyCode,
      minRecipientDenomination: Originalproduct.minRecipientDenomination || "",
      maxRecipientDenomination: Originalproduct.maxRecipientDenomination || "",
      senderCurrencyCode: Originalproduct.senderCurrencyCode || "",
      minSenderDenomination: Originalproduct.minSenderDenomination || "",
      maxSenderDenomination: Originalproduct.maxSenderDenomination || "",
      fixedRecipientDenominations: Originalproduct.fixedRecipientDenominations || "",
      fixedSenderDenominations: Originalproduct.fixedSenderDenominations,
      fixedRecipientToSenderDenominationsMap: Originalproduct.fixedRecipientToSenderDenominationsMap,
      logoUrls: Originalproduct.logoUrls,
      brand: {
        brandId: Originalproduct.brand.brandId,
        brandName: Originalproduct.brand.brandName,
      },
      country: {
        isoName: Originalproduct.country.isoName,
        name: Originalproduct.country.name,
        flagUrl: Originalproduct.country.flagUrl,
      },
      redeemInstruction: {
        concise: Originalproduct.redeemInstruction.concise,
        verbose: Originalproduct.redeemInstruction.verbose,
      },
    });
  ...
  //   };
    ...
    const handleSubmit = (e) => {
      ...
      updateProduct(dispatch, product, toast);
      onClose();
            ...
            <form onSubmit={(e) => handleSubmit(e)}>
              <ModalBody pb={6}>
                ...
                <FormControl>
                    ...
                    <Input placeholder="productId" name="productId" type="number" value={product.productId} onChange={handleChange} />
                  </FormControl>
